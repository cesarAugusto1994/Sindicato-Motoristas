...
function fator_vencimento($data) {
  if (!empty($data)) {
    ...
    $dataVencimento = \DateTime::createFromFormat('d/m/Y', $data);

    return(abs((_dateToDays("1997","10","07")) - (_dateToDays($dataVencimento->format('Y'), $dataVencimento->format('m'), $dataVencimento->format('d')))));
  } else {
    return "0000";
  }
}
