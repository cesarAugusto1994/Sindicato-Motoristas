...
this.err_select="Campo obrigatório !";
this.err_enter="Campo obrigatório !";
};
...
&&!(regex=="JSVAL_RX_CREDITCARD")&&!(regex=="JSVAL_RX_POSTALZIP")&&!(regex=="JSVAL_RX_DATA"))
{
nBegin=0;nEnd=0;
...
case "JSVAL_RX_DATA":
return((/^((0[1-9]|[12]\d)\/(0[1-9]|1[0-2])|30\/(0[13-9]|1[0-2])|31\/(0[13578]|1[02]))\/\d{4}$/).test(value));
break;
default:
