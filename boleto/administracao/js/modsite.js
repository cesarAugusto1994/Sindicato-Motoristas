...
Zapatec.Calendar._TT["PREV_YEAR"] = "Ano (hold for menu)";
Zapatec.Calendar._TT["PREV_MONTH"] = "Mes (hold for menu)";
Zapatec.Calendar._TT["GO_TODAY"] = "Voltar (hold for history)";
Zapatec.Calendar._TT["NEXT_MONTH"] = "Proximo mes (hold for menu)";
Zapatec.Calendar._TT["NEXT_YEAR"] = "Proximo ano (hold for menu)";
