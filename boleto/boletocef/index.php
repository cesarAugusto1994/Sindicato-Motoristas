...
<td align="left" width="64%" height="39"> <div align="left"><input name="cidade" type="text" id="cidade" size="25" maxlength="25"><strong> Estado:<select name="estado" size="1" id="estado">
